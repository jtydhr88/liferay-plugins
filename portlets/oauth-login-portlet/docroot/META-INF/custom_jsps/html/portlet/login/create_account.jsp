...
Object socialAccountId = session.getAttribute("LIFERAY_SHARED_socialAccountId");
Object oAuthConnectionId = session.getAttribute("LIFERAY_SHARED_oAuthConnectionId");

boolean isSocialLogin = false;

if ((socialAccountId != null) && (oAuthConnectionId != null)) {
	isSocialLogin = true;
}
System.out.println(socialAccountId);
System.out.println(oAuthConnectionId);
%>
...
<aui:form action="<%= createAccountURL %>" method="post" name="fm">
	...
	<c:if test="<%= (socialAccountId != null) && (oAuthConnectionId != null) %>">
		<%
		String expandoAttributeName = "ExpandoAttributeName--" + String.valueOf(oAuthConnectionId) + "_social_account_id--";

		String expandoAttributeNameValue = String.valueOf(oAuthConnectionId) + "_social_account_id";

		String expandoAttribute = "ExpandoAttribute--" + String.valueOf(oAuthConnectionId) + "_social_account_id--";
		%>

		<aui:input name="<%= expandoAttributeName %>" type="hidden" value="<%= expandoAttributeNameValue %>" />
		<aui:input name="<%= expandoAttribute %>" type="hidden" value="<%= socialAccountId %>" />
		<aui:input name="isSocialLogin" type="hidden" value="<%= isSocialLogin %>" />
	</c:if>
